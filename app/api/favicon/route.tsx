...
const faviconMapper: { [key: string]: string } = {
  '((?:zolplay.cn)|(?:zolplay.com)|(?:cn.zolplay.com))':
    'https://blog.liproject.top/favicons/zolplay.png',
  '(?:github.com)': 'https://blog.liproject.top/favicons/github.png',
  '((?:t.co)|(?:twitter.com)|(?:x.com))':
    'https://blog.liproject.top/favicons/twitter.png',
  'coolshell.cn': 'https://blog.liproject.top/favicons/coolshell.png',
  'vercel.com': 'https://blog.liproject.top/favicons/vercel.png',
  'nextjs.org': 'https://blog.liproject.top/favicons/nextjs.png',
}
...
export async function GET(req: NextRequest) {
  ...
  let iconUrl = 'https://blog.liproject.top/favicon_blank.png'
